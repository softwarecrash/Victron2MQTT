...
VICTRON_TEXT::VICTRON_TEXT(int rx, int tx)
{
    // SoftwareSerial myPort;
...
bool VICTRON_TEXT::getPackMeasurements() // 0x90
{
...
bool VICTRON_TEXT::getMinMaxCellVoltage() // 0x91
{
...
bool VICTRON_TEXT::getPackTemp() // 0x92
{
...
bool VICTRON_TEXT::getDischargeChargeMosStatus() // 0x93
{
...
bool VICTRON_TEXT::getStatusInfo() // 0x94
{
...
bool VICTRON_TEXT::getCellVoltages() // 0x95
{
...
bool VICTRON_TEXT::getCellTemperature() // 0x96
{
...
bool VICTRON_TEXT::getCellBalanceState() // 0x97
{
    int cellBalance = 0;
    int cellBit = 0;
...
bool VICTRON_TEXT::getFailureCodes() // 0x98
{
...
bool VICTRON_TEXT::setDischargeMOS(bool sw) // 0xD9 0x80 First Byte 0x01=ON 0x00=OFF
{
    if (sw)
    {
...
bool VICTRON_TEXT::setChargeMOS(bool sw) // 0xDA 0x80 First Byte 0x01=ON 0x00=OFF
{
    if (sw == true)
    {
...
bool VICTRON_TEXT::setBmsReset() // 0x00 Reset the BMS
{
...
bool VICTRON_TEXT::setSOC(float val) // 0x21 last two byte is SOC
{
    if (val >= 0 && val <= 100)
    {
...
bool VICTRON_TEXT::getState() // Function to return the state of connection
{
    return get.connectionState;
}

void VICTRON_TEXT::callback(std::function<void()> func) // start up save config callback
{
...
bool VICTRON_TEXT::requestData(COMMAND cmdID, unsigned int frameAmount) // new function to request global data
{
...
void VICTRON_TEXT::sendCommand(COMMAND cmdID)
{
    uint8_t checksum = 0;
...
bool VICTRON_TEXT::receiveBytes(void)
{
...
bool VICTRON_TEXT::validateChecksum()
{
...
void VICTRON_TEXT::barfRXBuffer(void)
{
...
void VICTRON_TEXT::clearGet(void)
{
